...
    </select>
		...
		<div class="col-sm-8">
		<input class="form-control" name="data[Word][en_words]" type="text" placeholder="English word"/>
		</div>
    </div>
...
(function(){
    ...
    for (var i = 0, select; select = selects[i]; i++) {
		...
		<div class="col-sm-8">
		<input class="form-control" name="data[Word][pl_words]" type="text" placeholder="Polish word"/>
		</div>
	</div>
	<div class="form-group form-group-lg">
